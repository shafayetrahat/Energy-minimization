...
df = pd.read_csv(
    './run/time_vs_box_2d_linked_cell.dat', 
...
plt.title('Simulation Time vs Box Size (with Particle Numbers (N), Density=0.3)', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.6)

# Show the plot
plt.tight_layout()
plt.savefig('./run/time_vs_box_2d_linked_cell.png')
plt.show()
